...
export default class UsuariosController{
    ...
    crear = async (req, res) => {
        ...
        if (nombre === undefined || apellido === undefined || correoElectronico === undefined || contrasenia === undefined || idTipoUsuario === undefined || imagen === undefined || activo === undefined ) {
    ...
    modificar = async (req, res) => {
        try {
            ...
            const usuarioActualizado = await this.service.modificar(idUsuario, { nombre, apellido, correoElectronico, contrasenia, idTipoUsuario, imagen, activo });
