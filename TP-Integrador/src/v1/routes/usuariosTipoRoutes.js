...
router.get('/:idUsuariosTipo', autorizarUsuarios([1]), usuariosTipoController.buscarPorId);
router.post('/', autorizarUsuarios([1]), usuariosTipoController.crear);
router.patch('/:idUsuariosTipo', autorizarUsuarios([1]), usuariosTipoController.modificar);
